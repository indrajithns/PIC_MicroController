...
void main(void) {
    ...
    static unsigned char digit [] = {0x3F, 0x06, 0x5B, 0x4F, 0x66, 0x6D, 0x7D, 0x07, 0x7F, 0x6F};
    unsigned char ssd [] = {0x3F, 0x3F, 0x3F, 0x3F};
    unsigned char key, reset;
    static unsigned int count = 0, key_pressed_time = 0;
    init_config();
