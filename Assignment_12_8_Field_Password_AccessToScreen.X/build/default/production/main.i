...
void read_input(void) {
    char actual_password[] = "000000000";
    ...
    if (j < 9)
    {
        ...
        if (key != ALL_RELEASED)
        {
            ...
            user_password[j] = number_entered + '0';

            clcd_putch(0x2A, (0xC0 + j + 3));
            j++;
            i++;
        }
        ...
        if (j == 9)
        {
            if (attempts++ < 5)
            {
                for (k = 0; k < 9; k++)
                {
                    if (user_password[k] != actual_password[k])
                    {
                        clcd_print("                    ", (0xC0 + 0));
                        clcd_putch(attempts + '0', (0xC0 + 1));
                        clcd_print("Attempts left", (0xC0 + 3));
                ...
                if (matched == 1)
                {
                    RB7 = 0;
                    0x01;
                    clcd_print("Successful! You", (0x80 + 0));
            ...
            } else
            {
                ...
                clcd_print("Reset the Board", (0xC0 + 0));
            }
        }
    }
    ...
    if (i < 9) {
        ...
        {
            clcd_putch(0x5F, (0xC0 + i + 3));
        } else if (blink % 2 == 1)
        {
            clcd_putch(0xFE, (0xC0 + i + 3));
        }
        if (flag >= 2)
        {
            if (blink % 2 == 0)
