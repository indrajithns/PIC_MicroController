...
void main(void) {
    ...
    while (1) {
        adc_reg_val = read_adc(0x00);

        val = (adc_reg_val * 500) / 1024;

        clcd_putch(((val / 10) % 10) + '0', (0xC0 + 5));
        clcd_putch((val % 10) + '0', (0xC0 + 6));
        clcd_print(".0", (0xC0 + 7));
        clcd_putch(0xDF, (0xC0 + 9));
