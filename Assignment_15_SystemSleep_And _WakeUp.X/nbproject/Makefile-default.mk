...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Assignment_15_SystemSleep_And__WakeUp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=external_interrupt.c isr.c main.c ssd.c timers.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/external_interrupt.p1 ${OBJECTDIR}/isr.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/ssd.p1 ${OBJECTDIR}/timers.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/external_interrupt.p1.d ${OBJECTDIR}/isr.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/ssd.p1.d ${OBJECTDIR}/timers.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/external_interrupt.p1 ${OBJECTDIR}/isr.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/ssd.p1 ${OBJECTDIR}/timers.p1

# Source Files
SOURCEFILES=external_interrupt.c isr.c main.c ssd.c timers.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Assignment_15_SystemSleep_And__WakeUp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Assignment_15_SystemSleep_And__WakeUp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/Assignment_15_SystemSleep_And__WakeUp.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp=${DFP_DIR}/xc8  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/Assignment_15_SystemSleep_And__WakeUp.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Assignment_15_SystemSleep_And__WakeUp.X.${IMAGE_TYPE}.hex 
