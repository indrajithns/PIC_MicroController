...
unsigned char eeprom_test(unsigned int count) {
    ...
    write_ext_eeprom(0x01, (count / 1000));
    write_ext_eeprom(0x02, (count / 100) % 10);
    write_ext_eeprom(0x03, (count / 10) % 10);
    write_ext_eeprom(0x04, (count % 10));
...
static unsigned char digits[] = {0x3F, 0x06, 0x5B, 0x4F, 0x66, 0x6D, 0x7D, 0x07, 0x7F, 0x6F};
unsigned char ssd[4] = {0x3F, 0x3F, 0x3F, 0x3F};

void main(void) {

    unsigned char key;
    static unsigned int key_pressed_time;
    int once = 0;
